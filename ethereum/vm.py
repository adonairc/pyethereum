...
def all_but_1n(gas, n=opcodes.CALL_CHILD_LIMIT_DENOM):
    return gas - (gas // n)
        ...
        if opcode < 0x10:
            ...
            if op == 'SHA3':
                ...
                if ext.post_anti_dos_hardfork():
                    if eat_gas(compustate, opcodes.BALANCE_SUPPLEMENTAL_GAS):
                        return vm_exception("OUT OF GAS")
            ...
            if ext.post_anti_dos_hardfork():
                ...
                gas = min(gas, all_but_1n(compustate.gas - extra_gas))
            else:
